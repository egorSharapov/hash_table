...
Можно отметить, что в топ по дисперсии вышла простая реализация хеш-функции в виде суммы элементов, её низкую дисперсию можно объяснить особенностью базы данных (словаря), где каждое слово отличается от другого ровно на 1 символ, что и обуславливает низкую дисперсию  распределения.
...
![alt text](plots/OP0_table.png?raw=true)
...
| :----------:   | :-------------------: | :------------------: | :---------------------: |
| `-O3`          |   28 213 150          |   1                  | 1                   |
| Optimization 1 |   26 171 127          |   1.08               | 1.08                    |

<details> 
<summary> Спойлер (граф вызовов) </summary>

![alt text](plots/OP1_table.png?raw=true)
...
#### **Реализация**
```C++
int strcmp_asm (char *string1, char *string2)
{
    int res = 0;
...
### **Третья оптимизация. Фиксирование длины ключа, выравнивание базы данных и замена strcmp на интринсик**


Так как две основная оптимизация была выполнена, пойдем на более серьезные ухищрения. 
...
| Optimization 1 |   26 171 127          |   1.08               | 1.08                    |
| Optimization 2 |   38 098 116          |   0.74               | 0.80                    |
| Optimization 3 |   18 637 764          |   1.51               | 2.05                    |
...
| Optimization 2 |   38 098 116          |   0.74               | 0.80                    |
| Optimization 3 |   18 637 764          |   1.51               | 2.05                    |
| Optimization 4 |    8 360 269          |   3.35               | 1.19                    |

<details> 
<summary> Спойлер (граф вызовов) </summary>

![alt text](plots/OP4_table.png?raw=true)
...
| Optimization 3 |   18 637 764          |   1.51               | 2.05                    |
| Optimization 4 |    8 360 269          |   3.35               | 1.19                    |
| Optimization 5 |    5 742 934          |   4.91               | 1.69                    |
...
![alt text](plots/OP5_table.png?raw=true)
...
| :----------:   | :---------------: | :------------------: | :------------------: | :---------------------: |
| Base version   |  `-O3`            | 28 213K              | 1                    | 1                        |
| Optimization 5 |  `-O3`            | 5 743K               | 4.91                 | 4.91                     |
